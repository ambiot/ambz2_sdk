...
DLLExport int MQTTV5Connect(MQTTClient* c, MQTTPacket_connectData* options, MQTTProperties* connectproperties, MQTTProperties* willproperties);

DLLExport int MQTTV5Disconnect(MQTTClient* c, int ReasonCode, MQTTProperties* DisconProperties);
