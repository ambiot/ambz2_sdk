...
DLLExport int MQTTV5PublishHandle(MQTTClient* c, const char* topicName, MQTTMessage* message, MQTTProperties* pubproperties);

DLLExport int MQTTV5Serialize_ack(unsigned char* buf, int buflen, unsigned char packettype, unsigned char dup, unsigned short packetid,
	int reasonCode, MQTTProperties* properties);
