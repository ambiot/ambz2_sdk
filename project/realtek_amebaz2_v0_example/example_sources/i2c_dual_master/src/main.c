...
int main(void)
{
    ...
    dbg_printf("\r\nMaster write>>> \r\n");
#ifdef I2C_RESTART_DEMO
    i2c_write(&i2cmaster, MBED_I2C_SLAVE_ADDR0, (const char *)&i2cdatasrc[0], 1, 0);
    i2c_write(&i2cmaster, MBED_I2C_SLAVE_ADDR0, (const char *)&i2cdatasrc[1], (I2C_DATA_LENGTH - 1), 1);
#else
