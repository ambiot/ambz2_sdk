...
In this example,
    ...
    When wake up by GPIO,
        a), if there is configured GPIO interrupt.
            ...
            2, if the GPIO interrupt has been activated the system will be resumed.
        b), if there is no configured GPIO interrupt.
            ...
            3, Please set PA_17 as GPIO interrupt for waking up the system. When the push button is pressed, the system will be resumed.
...
Note
    ...
    8, SleepCG will disable irq, if using any irq make sure enable it after SleepCG.
